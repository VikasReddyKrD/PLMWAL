...
export default class alphaSurveyQuestion extends NavigationMixin(LightningElement) {
    multiselectValues;
    val;
    @track values = [];
    @api question;
    ...
    onclickHandlerNew(event){   
        ...
        if(event.target.dataset.slider){
            if(this.selectedValue.includes('-')){
                let radioAnswerValues = this.selectedValue.split("-")[0];
                this.selectedValue = radioAnswerValues+"-"+event.target.value;
            ...
            // this.val[n-1] = event.detail.value;
            this.myValue = event.detail.value;
        }
    }
    // sameChange(event){
    ...
    renderedCallback(){
      ...
      /*  if(this.isCheckgroup){
        ...
        //     if(this.question.Display_Type__c === 'Text' && this.surveyanswer!=undefined){
       ...
       if(this.question.Display_Type__c === 'Date' && this.surveyanswer && this.surveyanswer?.Text_Response_Value__c){
                this.selectedValue = new Date(this.selectedAnswer?.Text_Response_Value__c);
       }
        else if(this.question.Display_Type__c === 'Checkbox Group' && this.surveyanswer!=undefined){
        ...
        else if(this.question.Display_Type__c === 'Text' && this.surveyanswer!=undefined && this.surveyanswer?.Text_Response_Value__c){
            this.selectedValue=this.surveyanswer.Text_Response_Value__c
        }
